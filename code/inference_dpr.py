...
import numpy as np
from arguments_dpr import DataTrainingArguments, ModelArguments
...
def run_dense_retrieval(
    ...
    p_encoder = AutoModel.from_pretrained(data_args.retriever_model_name_or_path).to(device)
    q_encoder = AutoModel.from_pretrained(data_args.retriever_model_name_or_path).to(device)
    ...
    retriever = DenseRetrieval(
        ...
        p_encoder=p_encoder,
        q_encoder=q_encoder,
        model_id=data_args.retriever_model_name_or_path,
        device=device,
    )
